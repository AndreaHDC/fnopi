...
<section {{$anchor}} class="alignfull py-12 lg:py-[100px] bg-fnopi-black">
    <div id="fnopi-stories">
        ...
        <div class="alignwide mx-auto px-6 lg:px-[60px] 2xl:px-[120px]">
            ...
            @if (count($stories))
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-6 mt-12">
                    @foreach ($stories as $story_id)
                        <div>
                            ...
                            <h3 class="text-fnopi-green uppercase font-bold my-3">{!!get_the_title($story_id)!!}</h3>
            ...
            <div class="lg:pl-[100px] mt-12 md:mt-24">
