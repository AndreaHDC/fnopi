                                ...
                                <div class="border border-solid border-black h-full">
                                    ...
                                    <a href="{{$milestone['link']}}">
                                        <div class="overflow-hidden">
                                            {!! wp_get_attachment_image($milestone['image'], 'square', false, ['class' => 'w-full h-auto transition-transform duration-500 hover:scale-110']) !!}
                                        </div>
                                    </a>
